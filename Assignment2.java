...
public class Assignment2 {
    ...
    System.out.println("");
    System.out.print("How many days would you lke to train your monster? ");
    ...
    System.out.println("| HP: " + initialHP + "      | HP: " + HP);
    System.out.println("| AP: " + initialAP + "      | AP: " + AP);
    System.out.println("| DP: " + initialDP + "       | DP: " + DP);
    System.out.println("| Level: " + initiallevel + "    | Level: " + level);
    int GuardianHP = 150;
    int GuardianAP = 35;
    int GuardianDP = 15;
    ...
    GuardianHP = GuardianHP - damageDealt;
        ...
        System.out.println("(Guardian HP: " + GuardianHP + "/150)");
    if(GuardianHP<=0){
    ...
    HP = HP - damageTaken;
        ...
        System.out.println("(Your HP: " + HP + "/" + initialHP + ")");
    if(HP<=0){
